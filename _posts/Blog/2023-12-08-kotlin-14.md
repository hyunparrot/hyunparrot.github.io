...
MenuItem 클래스를 추가하고, BurgerMenu, BeverageMenu, SideMenu, ExitProgram 클래스들이 이를 상속받도록 했다.

모든 메뉴를 하나의 리스트인 menuList로 관리하도록 했다.
